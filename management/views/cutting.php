...
<div class="container">
    ...
    <p class="display-4 text-center mt-4">Cutting Check</p>
    <div class="card mb-3">
        <div class="card-body">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="<?php echo $addr_space ?>cutting-check/" class="btn btn-primary"><i class="fas fa-sync"></i></a>
                        </div>
                    </div>
                </div>
                <div class="card mb-3">
            ...
            <table id="analysis_table" class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    foreach (array_unique($number_array) as $value) {
                        ...
                        if (($singleTotal * 9.5) - $total > 0) {
                            if (strlen($number) == 1) {
                                $panel = "<div class='badge badge-info p-2'>Single</div>";
                                $cost = (($singleTotal * 9.5) - $total) / 9.5;
                            } else {
                                switch ($panel) {
                                    case 3:
                            ...
                            $totalCutting = $totalCutting + $cost;
                            echo "<tr>";
                            echo "  <td></td>";
                            echo "  <td class='text-center'><p class='number'>" . $number . "</p></td>";
                            echo "  <td class='text-center'><p class='cutting text-danger'>" . number_format($cost)  . "</p></td>";
                            ...
                            if (strlen($number) != 1) {
                                switch ($panel) {
                                    case 3:
                                        $panel = "<div class='badge badge-info p-2'>SP</div>";
                                        $profit = $total - ($singleTotal * 9.5);
                                        $winning = ($cost * 150);
                                        $cost = $winning - $profit;

                                        if ($cost > 0) {
                                            $totalCutting = $totalCutting + ($cost / 150);

                                            echo "<tr>";
                                            echo "  <td></td>";
                                            echo "  <td class='text-center'><p class='number'>" . $number . "</p></td>";
                                            echo "  <td class='text-center'><p class='cutting text-danger'>" . number_format($cost / 150)  . "</p></td>";
                                            echo "  <td class='text-center'><div class='badge badge-dark p-2 mr-2'>" . $panna . "</div>" . $panel . "</td>";
                                            echo "</tr>";
                                        }
                                        break;
                                    case 2:
                                        ...
                                        if ($cost > 0) {
                                            $totalCutting = $totalCutting + (($cost / 300) + 25);

                                            echo "<tr>";
                                            echo "  <td></td>";
                                            echo "  <td class='text-center'><p class='number'>" . $number . "</p></td>";
                                            echo "  <td class='text-center'><p class='cutting text-danger'>" . number_format(($cost / 300) + 25)  . "</p></td>";
                                            echo "  <td class='text-center'><div class='badge badge-dark p-2 mr-2'>" . $panna . "</div>" . $panel . "</td>";
                                            echo "</tr>";
                                        }
                                        break;
                                    case 1:
                                        ...
                                        if ($cost > 0) {
                                            $totalCutting = $totalCutting + ($cost / 1000);

                                            echo "<tr>";
                                            echo "  <td></td>";
                                            echo "  <td class='text-center'><p class='number'>" . $number . "</p></td>";
                                            echo "  <td class='text-center'><p class='cutting text-danger'>" . number_format($cost / 1000)  . "</p></td>";
                                            echo "  <td class='text-center'><div class='badge badge-dark p-2 mr-2'>" . $panna . "</div>" . $panel . "</td>";
                                            echo "</tr>";
                                        }
                                        break;
    ...
    <div class="card mb-3">
        <div class="card-body">
            <p class="h3 text-center">Total Cutting : <span class="text-danger">

                    <?php
                    echo "₹ " . number_format($totalCutting);
                    ?>
                </span>
            </p>
